...
Windows XP, Windows Vista, Windows 7, Windows8 and Window 10.
The program t32marm.exe will not run on Windows 3.X, Windows95,
...
The manual is a reduced version of the full online manual.
