...
../../../../build/lm3s811/main.elf:     file format elf32-littlearm
...
00000010 <g_pfnVectors>:
      10:	20001910 00000001 0000006d 00000085     ... ....m.......
      20:	0000009d 000000b5 000000cd 000033d4     .............3..
      30:	000033d4 000033d4 000033d4 000000e5     .3...3...3......
      40:	000000fd 000033d4 00000115 0000012d     .....3......-...
...
void HardFault_Handler(void)
{
      ...
      86:	af00      	add	r7, sp, #0
    printf("[%s]\n", __func__);
      88:	4902      	ldr	r1, [pc, #8]	; (94 <HardFault_Handler+0x10>)
      8a:	4803      	ldr	r0, [pc, #12]	; (98 <HardFault_Handler+0x14>)
      8c:	f001 f8ab 	bl	11e6 <printf_>
    while(1);
      90:	e7fe      	b.n	90 <HardFault_Handler+0xc>
      92:	bf00      	nop
      94:	00002544 	.word	0x00002544
      98:	00002528 	.word	0x00002528

0000009c <MemManage_Handler>:
}
...
void MemManage_Handler(void)
{
      ...
      9e:	af00      	add	r7, sp, #0
    printf("[%s]\n", __func__);
      a0:	4902      	ldr	r1, [pc, #8]	; (ac <MemManage_Handler+0x10>)
      a2:	4803      	ldr	r0, [pc, #12]	; (b0 <MemManage_Handler+0x14>)
      a4:	f001 f89f 	bl	11e6 <printf_>
    while(1);
      a8:	e7fe      	b.n	a8 <MemManage_Handler+0xc>
      aa:	bf00      	nop
      ac:	00002558 	.word	0x00002558
      b0:	00002528 	.word	0x00002528

000000b4 <BusFault_Handler>:
}
...
void BusFault_Handler(void)
{
      ...
      b6:	af00      	add	r7, sp, #0
    printf("[%s]\n", __func__);
      b8:	4902      	ldr	r1, [pc, #8]	; (c4 <BusFault_Handler+0x10>)
      ba:	4803      	ldr	r0, [pc, #12]	; (c8 <BusFault_Handler+0x14>)
      bc:	f001 f893 	bl	11e6 <printf_>
    while(1);
      c0:	e7fe      	b.n	c0 <BusFault_Handler+0xc>
      c2:	bf00      	nop
      c4:	0000256c 	.word	0x0000256c
      c8:	00002528 	.word	0x00002528

000000cc <UsageFault_Handler>:
}
...
void UsageFault_Handler(void)
{
      ...
      ce:	af00      	add	r7, sp, #0
    printf("[%s]\n", __func__);
      d0:	4902      	ldr	r1, [pc, #8]	; (dc <UsageFault_Handler+0x10>)
      d2:	4803      	ldr	r0, [pc, #12]	; (e0 <UsageFault_Handler+0x14>)
      d4:	f001 f887 	bl	11e6 <printf_>
    while(1);
      d8:	e7fe      	b.n	d8 <UsageFault_Handler+0xc>
      da:	bf00      	nop
...
void DebugMon_Handler(void)
{
      ...
      fe:	af00      	add	r7, sp, #0
    printf("[%s]\n", __func__);
     100:	4902      	ldr	r1, [pc, #8]	; (10c <DebugMon_Handler+0x10>)
     102:	4803      	ldr	r0, [pc, #12]	; (110 <DebugMon_Handler+0x14>)
     104:	f001 f86f 	bl	11e6 <printf_>
    while(1);
     108:	e7fe      	b.n	108 <DebugMon_Handler+0xc>
     10a:	bf00      	nop
     10c:	000025a0 	.word	0x000025a0
     110:	00002528 	.word	0x00002528

00000114 <PendSV_Handler>:
}
...
void PendSV_Handler(void)
{
    ...
    printf("[%s]\n", __func__);
     118:	4902      	ldr	r1, [pc, #8]	; (124 <PendSV_Handler+0x10>)
     11a:	4803      	ldr	r0, [pc, #12]	; (128 <PendSV_Handler+0x14>)
     11c:	f001 f863 	bl	11e6 <printf_>
    while(1);
     120:	e7fe      	b.n	120 <PendSV_Handler+0xc>
     122:	bf00      	nop
     124:	000025b4 	.word	0x000025b4
     128:	00002528 	.word	0x00002528

0000012c <SysTick_Handler>:
}
...
void SysTick_Handler(void)
{
    ...
    printf("[%s]\n", __func__);
     130:	4902      	ldr	r1, [pc, #8]	; (13c <SysTick_Handler+0x10>)
     132:	4803      	ldr	r0, [pc, #12]	; (140 <SysTick_Handler+0x14>)
     134:	f001 f857 	bl	11e6 <printf_>
    while(1);
     138:	e7fe      	b.n	138 <SysTick_Handler+0xc>
     13a:	bf00      	nop
...
void task_entry_1(void* param)
{
    ...
    1392:	bf00      	nop
    1394:	00002604 	.word	0x00002604
    1398:	000025f8 	.word	0x000025f8
...
void task_entry_2(void* param)
{
    ...
    13b2:	bf00      	nop
    13b4:	00002614 	.word	0x00002614
    13b8:	000025f8 	.word	0x000025f8
...
uint8_t shell_get_args(char *line, char *args[], uint8_t args_len)
{
    ...
    166c:	bd80      	pop	{r7, pc}
    166e:	bf00      	nop
    1670:	00002624 	.word	0x00002624
    1674:	00002628 	.word	0x00002628
...
int shell_help_func(int argc, char **argv)
{
    ...
    16b4:	0000262c 	.word	0x0000262c
    16b8:	000033e4 	.word	0x000033e4
...
#define MAX_SHELL_LINE_LENGTH 128
    ...
    1950:	46bd      	mov	sp, r7
    1952:	bd80      	pop	{r7, pc}
    1954:	00002654 	.word	0x00002654
    1958:	00002514 	.word	0x00002514
    195c:	00002658 	.word	0x00002658
    1960:	00002660 	.word	0x00002660
    1964:	000033e4 	.word	0x000033e4
    1968:	0000267c 	.word	0x0000267c
...
void dump_stack(uint32_t stack_start_addr, size_t stack_size, uint32_t *stack_pointer)
{
    ...
    1ac4:	46bd      	mov	sp, r7
    1ac6:	bd80      	pop	{r7, pc}
    1ac8:	000031bc 	.word	0x000031bc
    1acc:	000026a4 	.word	0x000026a4
    1ad0:	000026d0 	.word	0x000026d0
...
return depth;
    ...
    1c0c:	bd80      	pop	{r7, pc}
    1c0e:	bf00      	nop
    1c10:	000031c8 	.word	0x000031c8
    1c14:	00002fe4 	.word	0x00002fe4
    1c18:	08080541 	.word	0x08080541
    1c1c:	00002ff4 	.word	0x00002ff4
    1c20:	2000002c 	.word	0x2000002c
    1c24:	20000034 	.word	0x20000034
    1c28:	00003000 	.word	0x00003000
...
void print_call_stack(uint32_t sp) {
    ...
    1cec:	bd80      	pop	{r7, pc}
    1cee:	bf00      	nop
    1cf0:	000031e0 	.word	0x000031e0
    1cf4:	000026a4 	.word	0x000026a4
    1cf8:	20000050 	.word	0x20000050
    1cfc:	00003044 	.word	0x00003044
    1d00:	00002880 	.word	0x00002880
    1d04:	0000304c 	.word	0x0000304c
    1d08:	00003054 	.word	0x00003054
    1d0c:	00003064 	.word	0x00003064
    1d10:	000028c0 	.word	0x000028c0
...
__attribute__( ( always_inline ) ) static inline uint32_t cmb_get_sp(void) {
    ...
    1d50:	000031f4 	.word	0x000031f4
    1d54:	00003068 	.word	0x00003068
...
void backtrace_level_2(void)
{
    ...
    1d70:	bf00      	nop
    1d72:	bd80      	pop	{r7, pc}
    1d74:	00003208 	.word	0x00003208
    1d78:	00003068 	.word	0x00003068
...
void backtrace_level_1(void)
{
    ...
    1d8c:	bf00      	nop
    1d8e:	bd80      	pop	{r7, pc}
    1d90:	0000321c 	.word	0x0000321c
    1d94:	00003068 	.word	0x00003068
...
//         fault_test_by_unalign();
    ...
    1f04:	00003230 	.word	0x00003230
    1f08:	00003070 	.word	0x00003070
    1f0c:	000030b8 	.word	0x000030b8
    1f10:	00003100 	.word	0x00003100
    1f14:	00003148 	.word	0x00003148
    1f18:	00003154 	.word	0x00003154
    1f1c:	00003160 	.word	0x00003160
    1f20:	0000316c 	.word	0x0000316c
...
void BackTraceSub(unsigned long sp)
{
    ...
    212c:	0000317c 	.word	0x0000317c
    2130:	000031a8 	.word	0x000031a8
...
000033d4 <Default_Handler>:
.section .text.Default_Handler,"ax",%progbits
Default_Handler:
    b .
    33d4:	e7fe      	b.n	33d4 <Default_Handler>
